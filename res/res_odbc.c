...
int odbc_dump_fd(cw_dynstr_t *ds_p, odbc_obj *obj)
{
...
static int odbc_connect_usage(cw_dynstr_t *ds_p)
{
	cw_dynstr_printf(ds_p, "usage odbc connect <DSN>\n");
	return 0;
}

static int odbc_disconnect_usage(cw_dynstr_t *ds_p)
{
	cw_dynstr_printf(ds_p, "usage odbc disconnect <DSN>\n");
	return 0;
}

static int odbc_show_command(cw_dynstr_t *ds_p, int argc, char **argv)
{
	odbc_obj *obj;
	int x = 0;
...
static int odbc_disconnect_command(cw_dynstr_t *ds_p, int argc, char **argv)
{
	odbc_obj *obj;
...
static int odbc_connect_command(cw_dynstr_t *ds_p, int argc, char **argv)
{
	odbc_obj *obj;
