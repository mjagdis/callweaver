...
typedef struct opbx_conference_stats
{
...
struct opbx_conference 
{
	...
	struct opbx_trans_pvt* from_slinear_paths[ AC_SUPPORTED_FORMATS ] ;
	
	// conference stats
	opbx_conference_stats stats ;
...
int queue_frame_for_listener( struct opbx_conference* conf, struct opbx_conf_member* member, conf_frame* frame ) ;
int queue_frame_for_speaker( struct opbx_conference* conf, struct opbx_conf_member* member, conf_frame* frame ) ;
int queue_silent_frame( struct opbx_conference* conf, struct opbx_conf_member* member ) ;
