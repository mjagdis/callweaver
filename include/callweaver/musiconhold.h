...
extern CW_RES_API_PUBLIC int cw_moh_start(struct cw_channel *chan, char *mclass);

/*! Turn off music on hold on a given channel */
extern void CW_RES_API_PUBLIC cw_moh_stop(struct cw_channel *chan);

extern void CW_RES_API_PUBLIC cw_install_music_functions(int (*start_ptr)(struct cw_channel *, char *),
