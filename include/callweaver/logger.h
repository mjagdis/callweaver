...
#define CW_EVENT_FLAG_LOG_ALL  (CW_EVENT_FLAG_ERROR | CW_EVENT_FLAG_WARNING | CW_EVENT_FLAG_NOTICE | CW_EVENT_FLAG_VERBOSE | CW_EVENT_FLAG_DTMF | CW_EVENT_FLAG_DEBUG)
