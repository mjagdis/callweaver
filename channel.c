...
OPENPBX_FILE_VERSION(__FILE__, "$Revision: 1.242 $")
...
/*--- ast_shutting_down: Returns non-zero if OpenPBX is being shut down */
...
/*--- ast_channel_register: Register a new telephony channel in OpenPBX */
