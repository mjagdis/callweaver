...
static int blt_show_information(cw_dynstr_t *, int, char**);
static int blt_show_peers(cw_dynstr_t *, int, char **);
static int blt_ag_sendcmd(cw_dynstr_t *, int, char **);
...
static void complete_device_2_ag(cw_dynstr_t *ds_p, char *argv[], int lastarg, int lastarg_len);
