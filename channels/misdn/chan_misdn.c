...
static int misdn_set_opt_exec(struct cw_channel *chan, int argc, char **argv, cw_dynstr_t *result);
static int misdn_facility_exec(struct cw_channel *chan, int argc, char **argv, cw_dynstr_t *result);
...
/*** CLI HANDLING ***/
static int misdn_set_debug(cw_dynstr_t *ds_p, int argc, char *argv[])
{
...
static int misdn_set_crypt_debug(cw_dynstr_t *ds_p, int argc, char *argv[])
{
...
static int misdn_port_block(cw_dynstr_t *ds_p, int argc, char *argv[])
{
	int port;
...
static int misdn_port_unblock(cw_dynstr_t *ds_p, int argc, char *argv[])
{
	int port;
...
static int misdn_restart_port (cw_dynstr_t *ds_p, int argc, char *argv[])
{
	int port;
...
static int misdn_port_up (cw_dynstr_t *ds_p, int argc, char *argv[])
{
	int port;
...
static int misdn_port_down (cw_dynstr_t *ds_p, int argc, char *argv[])
{
	int port;
...
static inline void show_config_description (cw_dynstr_t *ds_p, enum misdn_cfg_elements elem)
{
...
static int misdn_show_config (cw_dynstr_t *ds_p, int argc, char *argv[])
{
...
static int misdn_reload (cw_dynstr_t *ds_p, int argc, char *argv[])
{
...
static void print_bc_info (cw_dynstr_t *ds_p, struct chan_list* help, struct misdn_bchannel* bc)
{
...
static int misdn_show_cls (cw_dynstr_t *ds_p, int argc, char *argv[])
{
...
static int misdn_show_cl (cw_dynstr_t *ds_p, int argc, char *argv[])
{
	struct chan_list *help=cl_te;
...
static int misdn_set_tics (cw_dynstr_t *ds_p, int argc, char *argv[])
{
	if (argc != 4)
		return RESULT_SHOWUSAGE;
...
static int misdn_show_stacks (cw_dynstr_t *ds_p, int argc, char *argv[])
{
	int port;
...
static int misdn_show_ports_stats (cw_dynstr_t *ds_p, int argc, char *argv[])
{
	int port;
...
static int misdn_show_port (cw_dynstr_t *ds_p, int argc, char *argv[])
{
	int port;
...
static int misdn_send_cd (cw_dynstr_t *ds_p, int argc, char *argv[])
{
	char *channame; 
	char *nr; 
...
static int misdn_send_digit (cw_dynstr_t *ds_p, int argc, char *argv[])
{
	char *channame; 
	char *msg; 
...
static int misdn_toggle_echocancel (cw_dynstr_t *ds_p, int argc, char *argv[])
{
	char *channame; 
...
static int misdn_send_display (cw_dynstr_t *ds_p, int argc, char *argv[])
{
	char *channame; 
	char *msg; 
...
static void complete_ch(cw_dynstr_t *ds_p, char *argv[], int lastarg, int lastarg_len)
{
	if (lastarg == 3)
		cw_complete_channel(ds_p, argv[3], lastarg_len);
}

static void complete_debug_port(cw_dynstr_t *ds_p, char *argv[], int lastarg, int lastarg_len)
{
	switch (lastarg) {
		case 4:
...
static void complete_show_config(cw_dynstr_t *ds_p, char *argv[], int lastarg, int lastarg_len)
{
	char buffer[BUFFERSIZE];
	enum misdn_cfg_elements elem;
	int port = 0;
