...
static int reload_config(void)
{
	...
	while(v) {
		...
		if (!strcasecmp(v->name, "context")) {
			...
			allow_external_invites = opbx_true(v->value);
	...
	if (!allow_external_invites && OPBX_LIST_EMPTY(&domain_list)) {
		opbx_log(LOG_WARNING, "To disallow external INVITEs, you need to configure local SIP domains.\n");
