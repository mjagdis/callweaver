...
/* structure to hold the valid openpbx users */
struct oh323_user {
	char name[80];
	char context[80];
	char secret[80];
...
/* structure to hold the valid openpbx peers 
...
/** call_details struct call detail records 
	to openpbx for processing and used for matching up 
	openpbx channels to acutal h.323 connections */
...
/* This is a callback prototype function, called to collect
   the external RTP port from OpenPBX. */
...
/* This is a callback prototype function, called to send
   the remote IP and RTP port from H.323 to OpenPBX */ 
