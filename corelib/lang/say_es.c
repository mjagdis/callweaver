...
static int say_date_with_format(struct cw_channel *chan, time_t t, const char *ints, const char *lang, const char *format, const char *tz)
{
    ...
    for (offset = 0;  format[offset] != '\0';  offset++)
    {
            ...
            /* Shorthand for "Today", "Yesterday", or ABdY */
        {
            ...
            {
                res = cw_say_date_with_format(chan, t, ints, lang, "'digits/es-el' Ad 'digits/es-de' B 'digits/es-de' Y", tz);
            }
        }
            break;
        case 'q':
            /* Shorthand for "" (today), "Yesterday", A (weekday), or ABdY */
        {
            ...
            break;
        case 'R':
            res = cw_say_date_with_format(chan, t, ints, lang, "H 'digits/y' M", tz);
            break;
        case 'S':
            /* Seconds */
            if (tm.tm_sec == 0)
