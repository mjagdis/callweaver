...
static void module_generator(cw_dynstr_t *ds_p, char *argv[], int lastarg, int lastarg_len)
{
...
static int handle_modlist(cw_dynstr_t *ds_p, int argc, char *argv[])
{
...
static int handle_load(cw_dynstr_t *ds_p, int argc, char *argv[])
{
	struct load_module_args args;
	const char *path;
...
static void complete_fn(cw_dynstr_t *ds_p, char *argv[], int lastarg, int lastarg_len)
{
...
static int handle_reconfigure(cw_dynstr_t *ds_p, int argc, char *argv[])
{
	int x;
...
static void reconfigure_module_generator(cw_dynstr_t *ds_p, char *argv[], int lastarg, int lastarg_len)
{
...
static int handle_unload(cw_dynstr_t *ds_p, int argc, char *argv[])
{
	int x;
	int hangup = 0;
