...
int stun_remove_request(stun_trans_id *st) {
    struct stun_request *req_queue, *req_queue_prev, *delqueue;
    time_t now;
    int found=0;
	...
	struct stun_state *st)	
{
	...
	struct stun_request *req_queue,*req_queue_prev;
